...
urlpatterns = [
    ...
    path('accept_challenge/<int:battle_id>/<int:opponent_team_id>/', views.accept_challenge),
    path('create_battle/<int:user_team_id>/<int:opponent_id>/', views.create_battle),
